...
import JobSec from "@/pages/index/components/JobSec";
import api from "@/api";
...
const JobDetail = (props: any) => {
    ...
    const [curPos, setCurPos] = useState(tempCurPos);
    useEffect(() => {
                ...
                <div className={style.home_inner}>
                    ...
                    <div className={style.job_slider}>
                        <div className={style.slider_company}>
                            ...
                            <p className={style.gray}>
                                更新于：
                                {new Date(curPos.belongTo.createdAt)
                                    .toLocaleDateString()
                                    .replace(/\//g, "-")}
                            </p>
                        </div>
